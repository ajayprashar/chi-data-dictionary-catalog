"""PBIP and release package path constants.
...
PBIP_PROJECT = "chiddc"
RELEASE_ROOT_NAME = "chiddc"
DEMO_ROOT_NAME = RELEASE_ROOT_NAME  # legacy alias

REPO_PARQUET = rf"C:\AI\{RELEASE_ROOT_NAME}"
...
PACKAGE_ZIP_STEM = RELEASE_ROOT_NAME
...
# Docs-owned diagram; OPC-safe copy name for RegisteredResources (alphanumeric only).
SEMANTIC_DIAGRAM_DOC_PNG = "docs/assets/chi_ddc_semantic.png"
SEMANTIC_DIAGRAM_DOC_SVG = "docs/assets/chi_ddc_semantic.svg"
SEMANTIC_DIAGRAM_MMD = "docs/assets/chi_ddc_semantic.mmd"
SEMANTIC_DIAGRAM_FILE = "chiddcsemantic.png"
...
def registered_resources_dir(repo: Path) -> Path:
    return pbip_root(repo) / PBIP_REPORT_DIR / "StaticResources" / "RegisteredResources"
